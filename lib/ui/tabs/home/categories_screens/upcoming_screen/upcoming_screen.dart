...
class UpcomingScreen extends StatefulWidget {
  ...
  Object sortBy;
  String title;
  UpcomingScreen({super.key, required this.field, required this.sortBy, required this.title});
...
class _UpcomingScreenState extends State<UpcomingScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      viewModel.getUpcomingTodoFromFirestore(widget.field, widget.sortBy, isSort);
    });
  }
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ...
          bottomSheetDM.date = DateTime.now().add(const Duration(days: 1));
          ...
          showTodosBottomSheet(context, bottomSheetDM, homeViewModel, viewModel,
              null, null, widget.field, widget.sortBy);
        },
        ...
        children: [
          EasyDateTimeLine(
            ...
            onDateChange: (selectedDate) {
              ...
              viewModel.getUpcomingTodoFromFirestore(widget.field, widget.sortBy, false);
            },
    ...
    return Expanded(
      child: ListView.builder(
        ...
        itemBuilder: (context, index) => TodoWidget(todo: todos[index], viewModel: viewModel, homeScreenViewModel: homeViewModel,
          secondField: widget.field,
          secondSortBy: widget.sortBy,
        ),
      ),
    );
  }
